                    ...
                    <div className={ styles["herosection__content__details__left"] }>
                        <div>
                            ...
                            <div className={ styles["herosection__content__details__left__buttons"] }>
                                <div>
                                    <Link href="https://play.google.com/store/apps/details?id=com.slelinks.slelinks&pcampaignid=web_share"><Image src={ google } alt='Google svg' /></Link>
                                </div>
                                <div>
                                    <Link href="https://apps.apple.com/app/slelinks/id6471399868"><Image src={ apple } alt='Apple svg' /></Link>
                                </div>
