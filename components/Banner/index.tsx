        ...
        <div className={ styles["banner__content"] }>
            ...
            <div className={ styles["banner__content__text"] }>
                ...
                <h1>Ready to get started?</h1>
                  <p>You have seen the process now. It's simple, fast and seamless to get onboarded, all in less than 2 minutes. Get started now to efficiently manage all your rental properties all from one dashboard</p>
